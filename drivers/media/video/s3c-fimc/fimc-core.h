...
#define FIMC_MODULE_NAME	"s3c-fimc"
...
#define	S3C_FIMC_EFFECT_ORIGINAL	S3C_CIIMGEFF_FIN_BYPASS
#define	S3C_FIMC_EFFECT_ARBITRARY	S3C_CIIMGEFF_FIN_ARBITRARY
#define	S3C_FIMC_EFFECT_NEGATIVE	S3C_CIIMGEFF_FIN_NEGATIVE
#define	S3C_FIMC_EFFECT_ARTFREEZE	S3C_CIIMGEFF_FIN_ARTFREEZE
#define	S3C_FIMC_EFFECT_EMBOSSING	S3C_CIIMGEFF_FIN_EMBOSSING
#define	S3C_FIMC_EFFECT_SIKHOUETTE	S3C_CIIMGEFF_FIN_SILHOUETTE
...
{
	u32 cfg = readl(dev->regs + S3C_CIGCTRL);
...
static inline void fimc_hw_dis_capture(struct fimc_dev *dev)
{
	...
	writel(cfg, dev->regs + S3C_CIIMGCPT);
}
...
static inline u32 fimc_hw_get_frame_index(struct fimc_dev *dev)
{
	...
	reg = readl(dev->regs + S3C_CISTATUS);
	return (reg & S3C_CISTATUS_FRAMECNT_MASK) >>
		S3C_CISTATUS_FRAMECNT_SHIFT;
}
